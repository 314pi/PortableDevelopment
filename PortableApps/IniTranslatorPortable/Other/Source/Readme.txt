...
user in an INI file next to IniTranslatorPortable.exe called IniTranslatorPortable.ini.
...
copy AppNamePortable.ini from this directory to IniTranslatorPortable.ini next to
IniTranslatorPortable.exe. The options in the INI file are as follows:
