...
user in an INI file next to SWI-PrologPortable.exe called
SWI-PrologPortable.ini. If you are happy with the default options, it is not
...
SWI-PrologPortable.ini next to SWI-PrologPortable.exe. The options in the INI
file are as follows:
