...
user in an INI file next to CppcheckPortable.exe called CppcheckPortable.ini. If
...
AppNamePortable.ini from this directory to CppcheckPortable.ini next to
CppcheckPortable.exe. The options in the INI file are as follows:
